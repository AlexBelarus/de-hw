...
with DAG(
    ...
    local_test_task = PythonOperator(
    ...
    local_test_task >> download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task
